...
import { 
  ...
  Save, Check, AlertCircle, Settings, LogOut, Search,
  FileText, Phone, User, Briefcase, Home, Type, Eye, EyeOff, Lock
} from 'lucide-react';
import { photoCategories, defaultGalleryImages } from '@/data/content';
import type { GalleryImage } from '@/types';

// Admin password - you can change this
const ADMIN_PASSWORD = 'your-secure-password-2024';
...
export default function AdminPortal() {
  ...
  const handleSaveContent = () => {
    localStorage.setItem('siteContent', JSON.stringify(content));
    showNotification('success', 'Content saved! Refresh your main website to see changes.');
      ...
      <div className="min-h-screen bg-neutral-100 flex items-center justify-center p-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-500">Enter your password to access the editor</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 border border-neutral-200 rounded-lg focus:border-black focus:outline-none"
                autoFocus
              />
              <button
                type="button"
      ...
      <AnimatePresence>
        {notification && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -50 }}
            className={`fixed top-20 right-6 px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2 ${
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <label
                    htmlFor="file-upload"
                    className={`flex items-center gap-2 px-4 py-3 bg-black text-white rounded-lg hover:bg-neutral-800 transition-colors cursor-pointer ${isUploading ? 'opacity-50' : ''}`}
                  >
